...
<body>
<h1> LISTE DES STAGIAIRES DE LA FORMATION <?php if(isset($_GET["SISR"]))
	{

		echo "<p> (BTS Services Informatiques aux Organisations (SIO) - option SISR) </p>";
	} 
...
<?php
	...
	$resultat = mysqli_query($bdd,"SELECT*FROM notes WHERE Section='SISR'");     # la variable ($resultat) contient la requete de la table 'notes'
