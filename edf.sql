...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 29 Novembre 2016 à 19:20
...
INSERT INTO `employes` (`ID`, `NOM`, `PRENOM`, `POSTE`, `TEL`, `EMAIL`) VALUES
(4, 'Seras', 'Mario', 877, 655443322, 'mariokart@gmail.fr'),
(5, 'saisa', 'snai', 0, 0, ''),
(7, 'titi', 'toto', 0, 0, ''),
(12, '', '', 0, 0, ''),
(14, '', '', 0, 0, ''),
...
CREATE TABLE IF NOT EXISTS `notes` (
  ...
  `NOTE_Programmation` int(2) NOT NULL,
  `NOTE_Reseau` int(2) NOT NULL,
  `NOTE_Maths` int(2) NOT NULL,
  `NOTE_Anglais` int(2) NOT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `notes` (`ID`, `Section`, `NOM`, `PRENOM`, `NOTE_Programmation`, `NOTE_Reseau`, `NOTE_Maths`, `NOTE_Anglais`) VALUES
(1, 'SLAM', 'Diaby', 'Balamini', 10, 15, 20, 5),
(2, 'SLAM', 'Toto', 'Tata', 10, 4, 2, 9),
(9, 'PAQN', 'Robert', 'Pires', 2, 8, 8, 13),
(10, 'SISR', 'Trezeg', 'David', 8, 3, 2, 9),
(11, 'LINUX-KVM', 'Tete', 'Bobo', 7, 5, 15, 4),
(12, 'Yeye', 'Yeye', 'Yiyi', 8, 17, 7, 0),
(13, 'PAQI', 'Yeye', 'Yiyi', 8, 17, 7, 0),
(14, 'SISR', 'OOO', 'YEYE', 7, 0, 7, 20),
(15, 'ADMIN-R', 'Debe', 'Kebe', 8, 20, 19, 6),
(16, 'PAQN', 'Ulu', 'Serban', 2, 19, 20, 12),
(17, 'LINUX-KVM', 'Lola', 'Tia', 3, 11, 8, 9),
(18, 'TAI', 'ANELKA', 'Nicolas', 7, 6, 2, 12),
(19, 'TAI', 'Vivi', 'Wiko', 3, 12, 16, 6);
