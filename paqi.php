...
<h1> LISTE DES STAGIAIRES DE LA FORMATION <?php if(isset($_GET["PAQI"]))
	{

		echo "<p> (Parcours d'accès à la qualification aux métiers de la Maintenance informatique) </p>";
	}
...
<?php
	...
	$resultat = mysqli_query($bdd,"SELECT*FROM notes WHERE Section ='PAQI'");     # la variable ($resultat) contient la requete de la table 'notes'
