...
<body>
<h1> LISTE DES STAGIAIRES DE LA FORMATION <?php if(isset($_GET["admin-reseau"]))
	{
...
<?php
	...
	$resultat = mysqli_query($bdd,"SELECT*FROM notes WHERE Section='ADMIN-R'");     # la variable ($resultat) contient la requete de la table 'notes'
