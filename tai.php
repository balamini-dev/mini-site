...
<h1> LISTE DES STAGIAIRES DE LA FORMATION <?php if(isset($_GET["TAI"]))
	{

		echo "<p> (Technicien(ne) d'Assistance en Informatique (Titre Professionnel) ) </p>";
	}
...
<?php
	...
	$resultat = mysqli_query($bdd,"SELECT*FROM notes WHERE Section='TAI' ");     # la variable ($resultat) contient la requete de la table 'notes'
