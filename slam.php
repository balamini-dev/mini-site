...
<h1> LISTE DES STAGIAIRES DE LA FORMATION <?php if(isset($_GET["SLAM"]))
	{

		echo "<p> (BTS Services Informatiques aux Organisations (SIO) - option SLAM) </p>";
	}
...
<?php
	...
	$resultat = mysqli_query($bdd,"SELECT*FROM notes WHERE Section='SLAM'");     # la variable ($resultat) contient la requete de la table 'notes'
